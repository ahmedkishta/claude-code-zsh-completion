...
_claude_mcp_servers() {
  ...
  _describe 'serwery mcp' server_list
}
...
_claude_installed_plugins() {
  ...
  _describe 'zainstalowane wtyczki' plugins
}
...
_claude_sessions() {
  ...
  _describe 'identyfikatory sesji' sessions
}
...
_claude() {
  ...
  main_commands=(
    ...
    'migrate-installer:Migruj z globalnej instalacji npm do instalacji lokalnej'
